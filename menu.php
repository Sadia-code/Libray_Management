					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								<li class="nav-item"><a href="manage_student.php" class="nav-link">Manage Students</a></li>
								<li class="nav-item"><a href="manage_teacher.php" class="nav-link">Manage Teacher</a></li>
